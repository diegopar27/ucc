<template>
  <v-dialog v-model="paciente.estado" max-width="500">
    <v-card>
      ...
      <v-container>
        <v-row justify="start">
          <v-col cols="3" class="my-0 py-1"><h3>Nombre medicamento</h3> </v-col>
          <v-col cols="9" class="my-0 py-1">
            <h7> {{ patologia.tipoPatolg }} </h7>
          </v-col>
          <v-col cols="3" class="my-0 py-1"><h3>Cantidad</h3> </v-col>
          <v-col cols="9" class="my-0 py-1">
            <h7>
              {{ patologia.nombre }}
            </h7>
          </v-col>
          <v-col cols="3" class="my-0 py-1"><h3>Formula médica</h3> </v-col>
          <v-col cols="9" class="my-0 py-1">
            <h7>
              {{ patologia.tiempo }}
            </h7>
